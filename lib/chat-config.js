 ...
 * provider) — it has a genuine no-credit-card free tier (1,500 requests/day
 * on Flash, no expiration), unlike the Vercel AI Gateway used earlier, which
 * needs pre-purchased credits. Get a free key at https://aistudio.google.com
 * and set it as GOOGLE_GENERATIVE_AI_API_KEY (server-side only — see
 * .env.example). Swapping models is still a one-line change here.
 */
